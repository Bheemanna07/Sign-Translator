    ...
    <section id="services">
      <div className="container">
        <div className="row mt-5">
          ...
          >
            <div className="h2 section-heading" style={{ fontSize: '18px' }}>Our Services</div>
            <div className="col-lg-4 divider my-2" />
            <div className="text-center normal-text" style={{ fontSize: '16px' }}>
          ...
          <div className="row">
            <div className="col-lg-4 mt-5">
              <div className="card col-lg-12 h-100 d-flex flex-column justify-content-between card-background">
                ...
                <div className="card-body">
                  <h5 className="card-title" style={{ fontSize: '18px' }}>Convert</h5>
            ...
            <div className="col-lg-4 mt-5">
              <div className="card col-lg-12 h-100 d-flex flex-column justify-content-between card-background">
                ...
                <hr className="m-0"></hr>
                <div className="card-body">
                  <h5 className="card-title" style={{ fontSize: '18px' }}>Learn Sign</h5>
                  <p className="card-text" style={{ fontSize: '16px' }}>
            ...
            <div className="col-lg-4 mt-5">
              <div className="card col-lg-12 h-100 d-flex flex-column justify-content-between card-background">
                ...
                <div className="card-body">
                  <h5 className="card-title" style={{ fontSize: '18px' }}>Videos</h5>
                  <p className="card-text" style={{ fontSize: '16px' }}>
