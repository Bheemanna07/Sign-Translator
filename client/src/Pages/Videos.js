...
function Videos() {
  ...
  const handleSubmit = async (event) => {
    ...
    setValidated(true);
    navigate(`/sign-translator/video/${videoId}`, { replace: false });
  };
  ...
  return (
    <div className="container-fluid d-flex flex-column align-items-center px-0">
      <div className="container-fluid text-white" style={{background: 'linear-gradient(135deg, #0d9488 0%, #14b8a6 100%)', padding: '3rem 0'}}>
        <div className="container my-5">
          <div className="display-5 px-2 text-center">
            Explore ISL Videos!
          </div>
          <div className="lead text-center">
            Welcome to the ISL video section of Sign Translator. Create your own public
        ...
        <div className="container">
          <div className="row my-4">
            ...
            >
              ...
              <Link to='/sign-translator/create-video' className="btn btn-primary mt-4">
